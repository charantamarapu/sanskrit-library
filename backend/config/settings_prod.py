...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'granthas' / 'templates'],  # Add this line
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# IMPORTANT: This must match your Nginx location
STATICFILES_DIRS = []

DEFAULT_AUTO_FIELD = 'django.db.models.BigAutoField'

# CORS Settings - CRITICAL for Next.js connection
...
CSRF_TRUSTED_ORIGINS = ['https://sanskrit-digital-library.mooo.com']
